...
`pnpm dev:selva` runs the standalone Selva app instead. [CLAUDE.md](./CLAUDE.md) has the full setup.
...
Copy to your Grasshopper libraries folder (paths in [CLAUDE.md](./CLAUDE.md#installing-to-grasshopper)) and restart Rhino.
