...
> **Status: FULLY IMPLEMENTED except P3 (updated 2026-07-31).**
> Shipped 2026-07-22: P1-client (cross-solve geometry cache), P2 (assembly worker),
...
> The per-item text below is the original 2026-07-22 analysis — read it for the _why_, not
> for current status. Companion to
...
### Status of the three items this section listed as open (updated 2026-07-31)
...
3. ~~**P5 (deferred item)**~~ — **SHIPPED 2026-07-31.** Serial offset pass + parallel copy, and a
   partitioned (exact, order-independent) bbox reduction. Quantize and deflate stay serial by nature.
