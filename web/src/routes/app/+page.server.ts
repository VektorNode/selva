...
import { fetchParsedDefinitionIO, solveGrasshopperDefinition, inputsToDataTrees, GrasshopperResponseProcessor, fetchDefinitionIO } from "rhino-compute-core"
...
export const load = (async () => {
  ...
  const computeInputsByParamId = new Map(
    definition.inputs.map(input => [input.paramId, input])
  );
