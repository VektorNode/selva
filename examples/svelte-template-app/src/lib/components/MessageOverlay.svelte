<script lang="ts">
  ...
  type Props = {
    ...
    onDismissMessage: (
      type: "error" | "warning" | "computeError",
      index?: number,
    ) => void;
  ...
  const hasMessages = $derived(
    errorMessage || warnings.length > 0 || computeErrors.length > 0,
  );
...
{#if showMessages && hasMessages}
  <div
    class="absolute top-4 right-4 z-50 w-96 max-w-[calc(100vw-2rem)]"
        ...
        {#if errorMessage}
          ...
          >
            <div class="flex items-start gap-3">
              <div
                class="mt-0.5 flex h-5 w-5 items-center justify-center rounded-full bg-red-100"
              >
                <svg
                  class="h-3 w-3 text-red-600"
                  fill="currentColor"
              ...
              <div class="min-w-0 flex-1">
                ...
                <p class="mt-1 text-sm wrap-break-word text-red-700">
                  {errorMessage}
                </p>
              </div>
          ...
          >
            <div class="flex items-start gap-3">
              ...
              <div class="min-w-0 flex-1">
                ...
                <p class="mt-1 text-sm wrap-break-word text-red-700">{error}</p>
              </div>
          ...
          >
            <div class="flex items-start gap-3">
              ...
              <div class="min-w-0 flex-1">
                ...
                <p class="mt-1 text-sm wrap-break-word text-amber-700">
                  {warning}
                </p>
              </div>
...
{#if !showMessages && hasMessages}
  ...
  >
    <Button onclick={() => onShowMessagesToggle(true)}>
      ...
      <span
        class="absolute -top-2 -right-2 flex h-6 w-6 animate-bounce items-center justify-center rounded-full bg-white text-xs font-bold text-red-600 shadow-md"
      >
        {totalMessages}
      </span>
