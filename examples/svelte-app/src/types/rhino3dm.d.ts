declare module 'rhino3dm' {
  ...
  class Extrusion extends Surface {
     ...
     * @returns {Extrusion} Extrusion on success. null on failure.
     */
    static createCylinderExtrusion(
      cylinder: Cylinder,
      capBottom: boolean,
      capTop: boolean,
    ): Extrusion;
  ...
  class NurbsSurface extends Surface {
    ...
    static create(
      ...
      order0: number,
      order1: number,
      controlPointCount0: number,
      controlPointCount1: number,
    ): NurbsSurface;
    /**
  ...
  class PointCloud extends GeometryBase {
    ...
    /** ... */
    addRangePointsNormalsColorsValues(
      points: number[][],
      normals: number[][],
      colors: object[],
      values: number[],
