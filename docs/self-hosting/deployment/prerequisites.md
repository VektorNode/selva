...
Other hosts: use whatever Node-version mechanism they provide (nvm, a platform Node selector, a pre-installed runtime). The only requirement is Node 22+.
