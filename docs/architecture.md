...
- [Providers](./self-hosting/providers/overview.md): the backend model.
- [Get Started](./self-hosting/get-started/overview.md): stand it up.
- [Build your own app](./packages/build/overview.md): use the packages directly.
