...
> side — RANK 1) ahead of extracting the definitions slice into `@selvajs/server`
> ([embeddable-server-layer.md](../plans/embeddable-server-layer.md), item K4), so the migration
