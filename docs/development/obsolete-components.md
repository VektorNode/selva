...
This guide ensures consistent naming and organization of deprecated/obsolete components and their upgraders across the
Selva plugin.

## Purpose

All deprecated components and upgraders follow a **consistent pattern based on the last version they were valid for**.
