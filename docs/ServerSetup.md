...
Guide to setting up Rhino Compute servers for use with Selva.

## Official Rhino Compute
...
- [System Requirements](https://developer.rhino3d.com/guides/compute/system-requirements/)

## Custom Fork (VektorNode)

Selva uses a custom fork of Rhino Compute with enhanced features and compatibility.
