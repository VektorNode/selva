			...
			<Card.Content>
				<div class="flex flex-col gap-4">
					...
					<p class="text-muted-foreground text-xs">
						When enabled, users can render geometry locally in their browser without needing a
						remote server.
					</p>
					<div class="flex items-center gap-2">
						<Checkbox
					...
					<p class="text-muted-foreground text-xs">
						When disabled, users must press a "Calculate" button to trigger solving instead of
						automatic updates.
					</p>
					...
					<div class="mt-4 flex flex-col gap-2 border-t pt-4">
						...
						<p class="text-muted-foreground text-xs">
							Export your schema layout to share or back up. Import schemas to load saved layouts
							(.sls files).
						</p>
					</div>
				</div>
