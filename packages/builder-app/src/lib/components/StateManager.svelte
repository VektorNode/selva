<script lang="ts">
  ...
  import type { UISchema, ParameterPreset } from '@selva/ui-shared';
  import {
    createSavedState,
    validateSavedState,
  ...
  import { Button, Input, Label, Textarea, Dialog, Card } from '@selva/ui-shared';
    ...
    {#if validationResult}
      <div class="grid gap-4 py-4">
        ...
        {#if validationResult.isValid}
          <Card.Root class="border-green-200 bg-green-50 p-4 dark:border-green-900 dark:bg-green-950">
