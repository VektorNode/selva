...
describe('§2 sole-admin invariant — DELETE /api/admin/users/[id]', () => {
...
describe('§2 sole-admin invariant — POST /api/admin/users/[id]/disable', () => {
...
describe('§2 sole-admin invariant — PATCH /api/admin/users/[id] permissions', () => {
