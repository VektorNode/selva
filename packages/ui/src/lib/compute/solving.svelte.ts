...
/**
 * Solving indicator whose visibility delay adapts to the running average solve time,
 * so quick solves don't flicker and slow ones show without delay. With no history yet,
 * the first solve shows immediately.
 */
