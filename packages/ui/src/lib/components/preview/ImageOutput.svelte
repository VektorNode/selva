<script lang="ts">
	...
	// Binary formats (PNG/JPG/WEBP/GIF) arrive base64; SVG arrives as plain UTF-8 XML and
	// needs percent-encoding into the data URL.
	// Rendering through <img src> instead of {@html} or an inline <svg> is deliberate:
	// browsers disable scripting in image-context SVGs, so untrusted SVG can't execute.
