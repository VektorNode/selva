...
<!-- Menu Toggle Button -->
<button
	class="absolute bottom-4 left-4 z-50 flex h-12 w-12 items-center justify-center rounded-lg bg-white shadow-lg transition-all hover:bg-gray-50 hover:shadow-xl active:scale-95"
...
{#if isOpen}
	...
	></button>
	<div
		class="animate-in fade-in slide-in-from-bottom-2 absolute bottom-20 left-4 z-50 flex min-w-60 flex-col gap-2 rounded-lg border border-gray-200 bg-white p-3 shadow-xl duration-200"
	>
		<div class="px-2 py-1">
			<h3 class="text-xs font-semibold tracking-wider text-gray-700 uppercase">Viewer Settings</h3>
		</div>
		...
		<div class="px-2 py-2 text-xs text-gray-500">
			<p class="mb-1 font-medium text-gray-600">Camera Controls:</p>
