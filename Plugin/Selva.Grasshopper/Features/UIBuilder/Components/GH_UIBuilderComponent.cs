...
using Selva.Grasshopper.Features.UIBuilder.Models;
using Selva.Grasshopper.Features.UIBuilder.Services;
using Selva.Grasshopper.Features.UIBuilder.Services.Events;
using Selva.Grasshopper.Features.UIBuilder.Services.State;
using Selva.Grasshopper.Features.UIBuilder.Services.UI;
...
public class GH_UIBuilderComponent : GH_Component, IDisposable
{
  ...
  {
    var document = OnPingDocument();
    if (document == null || _embeddedSchema == null || _service?.SchemaManager == null)
    {
