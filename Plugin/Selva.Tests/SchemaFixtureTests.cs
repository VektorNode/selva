...
public class SchemaFixtureTests
{
    ...
    private class FixtureExpectations
    {
        ...
        /// </summary>
        public Dictionary<string, InputExpectation> Inputs { get; init; } = new();
    }
    ...
    /// </summary>
    private static Dictionary<string, FixtureExpectations> CreateExpectations() => new()
    {
        ["v1.0.0.json"] = new()
        {
            InputCount = 2,
            ...
            Inputs = new()
            {
                ["Width"] = new() { ParamType = "number", InputStructure = "item" },
                ["Height"] = new() { ParamType = "number", InputStructure = "item" },
            }
        },
        ["v2.2.0.json"] = new()
        {
            ...
            {
                ["Width"] = new() { ParamType = "number", InputStructure = "item" },
                ["Material Color"] = new() { ParamType = "color", InputStructure = "item" },
            }
        },
        ["v2.3.0.json"] = new()
        {
            ...
            Inputs = new()
            {
                ["Width"] = new() { InputStructure = "item" },
                ["Points"] = new() { InputStructure = "list" },
                ["DataTree"] = new() { InputStructure = "tree" },
    ...
    private static string ReadFixture(string fileName) =>
        File.ReadAllText(Path.Combine("TestFiles", "schemas", fileName));
}
