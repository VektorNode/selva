	...
	private void MigrateInternalizedData(IGH_Param oldParam, IGH_Param newParam)
	{
		...
		else
		{
			...
			var oldProp = oldParam.GetType()
					.GetProperty("PersistentData", System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Instance);
			...
			if (oldProp != null && newProp != null)
			{
				...
				{
					newData.GetType()
							.GetMethod("CopyFrom", System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Instance)
