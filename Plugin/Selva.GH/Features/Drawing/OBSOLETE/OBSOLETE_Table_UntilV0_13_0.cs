...
/// <summary>
///     Obsolete Table component (until v0.13.0). Replaced by the version whose Column Widths
///     input is a number list (+mm / 0 = Auto / -weight = Star) instead of the "40 auto 1*" DSL.
/// </summary>
public class OBSOLETE_Table_UntilV0_13_0 : GH_Component
{
    public OBSOLETE_Table_UntilV0_13_0()
        : base("Table", "Table",
