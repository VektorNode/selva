...
{
    public DateTime Version => new(2026, 3, 12);
    public Guid UpgradeFrom => new("D7A3E1C5-B248-4F9A-8C6D-2E5F1A3B7D9E");
    public Guid UpgradeTo => new("F9B3F862-611E-4E67-9DE4-67129CC0EF24");
