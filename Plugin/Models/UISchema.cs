...
namespace ComputeBuilder.Plugin.Models
{
    ...
    public class UISchema
    {
        ...
        [JsonProperty("created")] public DateTime Created { get; set; } = DateTime.UtcNow;

        [JsonProperty("inputs")] public List<InputParamSchema> Inputs { get; set; } = new List<InputParamSchema>();

        [JsonProperty("outputs")] public List<OutputParamSchema> Outputs { get; set; } = new List<OutputParamSchema>();

        [JsonProperty("layout")] public LayoutConfig Layout { get; set; } = new LayoutConfig();
    ...
    public class IoParamSchema
    {
        ...
        [JsonProperty("paramType")] public string ParamType { get; set; }
    }
    ...
    public class InputParamSchema : IoParamSchema
    {
        ...
        [JsonProperty("atLeast")] public int AtLeast { get; set; } = 1;

        [JsonProperty("atMost")] public int AtMost { get; set; } = int.MaxValue;

        [JsonProperty("treeAccess")] public bool TreeAccess { get; set; }
        ...
        [JsonProperty("maximum")] public object Maximum { get; set; }

        [JsonProperty("stepSize")] public double? StepSize { get; set; }
    }
    ...
    public class WidgetConfig
    {
        ...
        [JsonProperty("renderAsSlider")] public bool? RenderAsSlider { get; set; }
    ...
    public class LayoutItem
    {
        ...
        [JsonProperty("span")] public int Span { get; set; } = 1;

        [JsonProperty("config")] public WidgetConfig Config { get; set; } = new WidgetConfig();
    }
    ...
    public class LayoutConfig
    {
        ...
        [JsonProperty("gap")] public int Gap { get; set; } = 16;

        // For "tabbed" layout
        [JsonProperty("tabs")] public List<TabConfig> Tabs { get; set; } = new List<TabConfig>();

        // For "flat" layout
        [JsonProperty("items")] public List<LayoutItem> Items { get; set; } = new List<LayoutItem>();
    }
    ...
    public class TabConfig
    {
        ...
        [JsonProperty("groups")] public List<GroupConfig> Groups { get; set; } = new List<GroupConfig>();
    }
    ...
    public class SessionState
    {
        ...
        [JsonProperty("lastUpdate")] public DateTime LastUpdate { get; set; } = DateTime.UtcNow;
    ...
    public class AvailableParameter
    {
        ...
        [JsonProperty("stepSize")] public decimal? StepSize { get; set; }
    }
    ...
    public class AvailableParameters
    {
        ...
        public List<AvailableParameter> Parameters { get; set; } =
            new List<AvailableParameter>();
    }
}